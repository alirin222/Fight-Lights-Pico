...
colors = [red,orange,light_orange,yellow,lime,green,turqoise,blue,light_blue,violet,pink,cyan,white,blueviolet,Lavender,Violet2,Magenta,DarkViolet]
...
k1_MyButton.set_config((7,8,), pink, True)
k2_MyButton.set_config((5,6,), pink, True)
k3_MyButton.set_config((3,4,), pink, True)
k4_MyButton.set_config((1,2,), pink, True)
p1_MyButton.set_config((9,10,), DarkViolet, True)
p2_MyButton.set_config((11,12,), DarkViolet, True)
p3_MyButton.set_config((13,14,), DarkViolet, True)
p4_MyButton.set_config((15,16,), DarkViolet, True)
...
ledOptions_confirm = [p1_MyButton]
